...
describe('My Login application', () => {
  ...
  before(async () => {
    ...
    await func.navigateMenu(utilLocators.menu.groupMaintenance1);
  ...
  it('Add Group Maintenanace', async () => {
    ...
    const result = await func.setUniqueValue(locators.fields.groupName, locators.fields.errorCode, false, 10);
    ...
    await func.verifySearch(locators.fields.searchgroupMaintenance, result);
  })
