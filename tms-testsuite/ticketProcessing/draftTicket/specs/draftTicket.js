...
describe('My Login application', () => {
    ...
    it('Add Manual eTicket', async () => {
        ...
        await func.waitAndFill(locators.fields.ticketissueDate, draftTicketTestData.issueDate, [Key.Escape], true);
        ...
        await func.waitAndFill(locators.fields.idNumber, draftTicketTestData.idnumber, 3000, false, true);
        await func.waitAndFill(locators.fields.idNumberconfirmation, draftTicketTestData.confirmidnumber, 3000,false, true);
        ...
        // await func.waitAndFill(locators.fields.fname, draftTicketTestData.firstname, 3000, false, true);
        // await func.waitAndFill(locators.fields.mname, draftTicketTestData.middlename, 3000,false, true);
        // await func.waitAndFill(locators.fields.lname, draftTicketTestData.lastname, 3000,false ,true);
        ...
        // await func.waitAndFill(locators.fields.streetNo, draftTicketTestData.streetnumber, 3000,false,true);
        // await func.waitAndFill(locators.fields.streetName, draftTicketTestData.sname, 3000,false, true);
        // await func.waitAndFill(locators.fields.mark, draftTicketTestData.mark, 3000,false, true);
        // await func.waitAndFill(locators.fields.pobox, draftTicketTestData.pobox, 3000,false, true);
        // await func.waitAndFill(locators.fields.poname, draftTicketTestData.poname, 3000,false, true);
        // await func.waitAndFill(locators.fields.parishone, draftTicketTestData.parish11, 3000,false, true);
        // await func.waitAndFill(locators.fields.city, draftTicketTestData.city, 3000,false, true);
        // await func.waitAndFill(locators.fields.state, draftTicketTestData.state, 3000,false,true);
        // await func.waitAndFill(locators.fields.zipcode, draftTicketTestData.zcode, 3000,false,true);
        ...
        await func.waitAndFill(locators.fields.fine, draftTicketTestData.fine, 3000,false, true);
        await func.waitAndFill(locators.fields.demiritpoints, draftTicketTestData.demiritpoints, 3000,false, true);
        await func.waitAndFill(locators.fields.offencedesc, draftTicketTestData.offencedesc, 3000, false,true);
