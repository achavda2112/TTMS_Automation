...
describe('My Login application', () => {
    ...
    it('Add Manual eTicket', async () => {
        ...
        result = await func.setUniqueValue(locators.fields.ticketNumber, locators.fields.errorCode, true, 5, "MT0");
        console.log("-----------Result---------", result);
        await func.waitAndFill(locators.fields.ticketNumberConfirmation, result);
        await func.waitAndFill(locators.fields.ticketissueDate, manualTicketTestData.issueDate, [Key.Escape], true);
        await func.waitAndClick(locators.button.next, 1000);

        //Offender Information

        await func.selectDropdown(locators.fields.idType, 1, locators.fields.idSelect);
        await func.waitAndFill(locators.fields.idNumber, manualTicketTestData.idnumber, 3000, false,true);
        await func.waitAndFill(locators.fields.idNumberconfirmation, manualTicketTestData.confirmidnumber, 3000, false,true, [Key.Enter]);
        ...
        // await func.waitAndFill(locators.fields.fname, manualTicketTestData.firstname, 3000, false,true);
        // await func.waitAndFill(locators.fields.mname, manualTicketTestData.middlename, 3000,false,true);
        // await func.waitAndFill(locators.fields.lname, manualTicketTestData.lastname, 3000,false,true);
        ...
        // await func.waitAndFill(locators.fields.streetNo, manualTicketTestData.streetnumber, 3000,false,true);
        // await func.waitAndFill(locators.fields.streetName, manualTicketTestData.sname, 3000, false,true);
        // await func.waitAndFill(locators.fields.mark, manualTicketTestData.mark, 3000, false,true);
        // await func.waitAndFill(locators.fields.pobox, manualTicketTestData.pobox, 3000, false,true);
        // await func.waitAndFill(locators.fields.poname, manualTicketTestData.poname, 3000, false,true);
        // await func.waitAndFill(locators.fields.parishone, manualTicketTestData.parish11, 3000, false,true);
        // await func.waitAndFill(locators.fields.city, manualTicketTestData.city, 3000, false,true);
        // await func.waitAndFill(locators.fields.state, manualTicketTestData.state, 3000,false,true);
        // await func.waitAndFill(locators.fields.zipcode, manualTicketTestData.zcode, 3000,false,true);
        ...
        await func.selectDropdown(locators.fields.selectoffence, 5, locators.fields.valueSelect);
        // await func.waitAndFill(locators.fields.fine, manualTicketTestData.fine, 3000, false,true);
        // await func.waitAndFill(locators.fields.demiritpoints, manualTicketTestData.demiritpoints, 3000, false,true);
        // await func.waitAndFill(locators.fields.offencedesc, manualTicketTestData.offencedesc, 3000, false,true);
        ...
        await func.waitAndClick(locators.button.next, 1000);
        await func.selectDropdown(locators.fields.inforcementOfficer, 1, locators.fields.valueSelect);
