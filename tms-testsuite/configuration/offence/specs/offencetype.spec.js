...
describe('My Login application', () => {
  ...
  it('Add Offence Type', async () => {
    ...
    const result = await func.setUniqueValue(locators.fields.offencetypecode, locators.fields.errorCode, false, 10);
    ...
    await func.setNumbervalue(locators.fields.fineAmounts, offenceTestData.fineAmountsvalue,3000);
   ...
   it('Edit Offence Type', async () => {   
     ...
     await func.waitAndClick(locators.button.saveoffencetype, 1000);
   })
});