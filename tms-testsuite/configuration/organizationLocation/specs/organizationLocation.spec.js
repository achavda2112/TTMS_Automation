...
describe('My Login application', () => {
  ...
  it('Add Organization Location', async () => {
    ...
    const result = await func.setUniqueValue(locators.fields.organizationLocationcode, locators.fields.errorCode,6);
    ...
    await func.selectDropdown(locators.fields.parish, 3, locators.fields.selectParish);
