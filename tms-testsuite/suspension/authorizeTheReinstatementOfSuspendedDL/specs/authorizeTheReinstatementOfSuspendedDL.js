...
let handles;
    ...
    it('Suspend Licences By Points', async () => {
        ...
        await func.waitAndFillWithMore(locators.fields.effectiveStartDate, authorizeTheReinstatementOfSuspendedDLTestData.effectiveStartDate, 2000);
        await func.waitAndFillWithMore(locators.fields.effectiveEndDate, authorizeTheReinstatementOfSuspendedDLTestData.effectiveEndDate, 2000);
