...
let handles;
    ...
    it('surrendering Of Drivers License', async () => {
        ...
        // await func.waitAndFillWithMore(locators.fields.effectiveStartDate, printNoticeOfSuspensionTestData.effectiveStartDate, 2000);
        // await func.waitAndFillWithMore(locators.fields.effectiveEndDate, printNoticeOfSuspensionTestData.effectiveEndDate, 2000);
        ...
        await func.waitAndFillWithMore(locators.fields.dateReceived, surrenderingOfDriversLicenseTestData.dateReceived, 2000);
