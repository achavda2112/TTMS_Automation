import * as locators from "../printReissueNoticeToTAJLocators"
import * as printNoticeOfSuspensionTestData from "../printReissueNoticeToTAJTestData"
...
let handles;
    ...
    before(async () => {
        ...
        await func.navigateMenu(utilLocators.menu.printreissueNoticeToTAJ);
    });
