import * as locators from "../dLDisqualificationByCourtLocators"
import * as dLDisqualificationByCourtTestData from "../dLDisqualificationByCourtTestData"
...
describe('My Login application', () => {
    ...
    before(async () => {
        ...
        await func.navigateMenu(utilLocators.menu.dLDisqualificationByCourt);
    });

    it('Filter Ticket', async () => {
        await func.waitAndFill(locators.fields.informationNumber, dLDisqualificationByCourtTestData.informationNumber, 2000);
