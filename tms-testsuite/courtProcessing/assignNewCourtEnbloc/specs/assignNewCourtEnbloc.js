...
describe('My Login application', () => {
    ...
    it('Print CourtSheet', async () => {
        ...
        await func.waitAndFill(locators.fields.oldcourtDate1, assignNewCourtEnblocTestData.oldCourtDate, 2000, true);
      ...
      //  await func.waitAndFill(locators.fields.newCourtDate1, assignNewCourtEnblocTestData.newCourtDate, 2000, true);
